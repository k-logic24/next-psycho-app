...
const RegisterForm: React.FC<FormProps> = ({
  ...
  const onSubmit = (data) => {
    ...
    data.question === '' ? setQuestionValidate(true) : setQuestionValidate(false)
    data.normal === '' ? setNormalValidate(true) : setNormalValidate(false)
    data.abnormal === '' ? setAbnormalValidate(true) : setAbnormalValidate(false)
  ...
  return (
    <Form onSubmit={handleSubmit(onSubmit)}>
      <Form.Group controlId="title">
        ...
        {isTitleValidate &&
          <span className="text-danger d-inline-block ml-3">タイトルを記入してください</span>
        }
        <Form.Control
          ref={register}
          type="text"
      ...
      <Form.Group controlId="question">
        ...
        {isQuestionValidate &&
          <span className="text-danger d-inline-block ml-3">内容を記入してください</span>
        }
        <Form.Control
          ref={register}
          as="textarea"
      ...
      <Form.Group controlId="normal">
        ...
        {isNormalValidate &&
          <span className="text-danger d-inline-block ml-3">一般回答を記入してください</span>
        }
        <Form.Control
          ref={register}
          as="textarea"
      ...
      <Form.Group controlId="abnormal">
        ...
        {isAbnormalValidate &&
          <span className="text-danger d-inline-block ml-3">サイコパス回答を記入してください</span>
        }
        <Form.Control
          ref={register}
          as="textarea"
